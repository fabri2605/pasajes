        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <form class="mt-8 mx-3 pb-3 px-3" enctype="multipart/form-data" class="mt-8" method="post"
                        ...
                        <div class="flex items-center justify-center w-full py-3">
                            <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 py-3">Solo seran admitidos archivos formato exel</p>
                                </div>
                        ...
                        <div class="mt-5">
                            <x-button type="submit" class="block h-12 w-auto">Cargar</x-button>
